...
const CardSlider = () => {
  ...
  return (
    <>
      <div className="text-white relative py-8 font-semibold px-4 text-3xl flex flex-col gap-5 max-w-[650px]">
...
function Arrow(props) {
  ...
  return (
    <svg
      ...
      className={`w-[30px] border-2 p-2 border-gray1 rounded-lg absolute cursor-pointer translate-y-[-50%] lg:top-[10%] top-[7%] ${
